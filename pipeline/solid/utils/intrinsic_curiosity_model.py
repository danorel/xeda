...
class IntrinsicCuriosityForwardModel:
    def __init__(
        self,
        prediction_input_state_dim,
        target_input_state_dim,
        output_dim,
        lr,
        agent_name,
        model_path=None,
        ...
        self.lr = lr
        self.prediction_model = self.create_model(self.prediction_input_state_dim)
    ...
    def train(self, input_state, output_state):
        with tf.GradientTape() as tape:
            ...
            grads = tape.gradient(loss, self.prediction_model.trainable_variables)
