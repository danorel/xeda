...
class FilterDefinition(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {
                "leftOperand": {"value": "projects.start_year", "type": "Column"},
                "rightOperand": {"value": 2018, "type": "Number"},
                "operator": "=",
            }
        }
...
class SetDefinition(BaseModel):
    ...
    joinFilters: List[FilterDefinition] = Field([], description="The join conditions")
            ...
            "example": {
                ...
                "joinFilters": [
                    ...
                    },
                    {
                        ...
                        "rightOperand": {"value": "topics.code", "type": "Column"},
                        "operator": "=",
                    },
                ],
                "valueFilters": [
                    {
                        "leftOperand": {"value": "projects.end_year", "type": "Column"},
                        "rightOperand": {"value": 2020, "type": "Number"},
                        "operator": "=",
                    },
                    {
                        "leftOperand": {
                        ...
                        "rightOperand": {"value": "FP7", "type": "String"},
                        "operator": "=",
                    },
                ],
            }
...
class RequestDataBody(BaseModel):
    database: DatabaseName = Field(
        ..., title="Database name", description="The name of the database to work on"
    )
...
class ByFilterBody(RequestDataBody):
    filter: FilterDefinition = Field(..., description="The new filter to be applied")
    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "filter": {
                    "leftOperand": {"value": "projects.start_year", "type": "Column"},
                    "rightOperand": {"value": 2016, "type": "Number"},
                    "operator": "=",
                },
            }
        }
...
class ByFacetBody(RequestDataBody):
    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "attributes": ["projects.start_date", "projects.ec_fund_scheme"],
                "numberOfFacets": 4,
            }
        }


class ByNeighborsBody(RequestDataBody):
    attributes: List[str] = Field(
    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "attributes": ["projects.total_cost", "projects.ec_fund_scheme"],
            }
        }


class ByOverlapBody(RequestDataBody):
    ...
    maxDuration: float = Field(
        5,
        gt=0,
        description="The maximum duration in seconds allowed to run the operation",
    )
...
class ByJoinBody(RequestDataBody):
    joinedTables: List[str] = Field(..., description="The list of tables to be joined")
...
class OperatorRequestResponse(BaseModel):
    ...
    payload: List[str] = Field(
        None, description="The list of queries resulting of the operation"
    )
